...
public:
  ...
  bool GetWasmLocal(uint32_t module_id, int index, int frame_index, uint64_t &value);
  bool GetWasmStackValue(uint32_t module_id, int index, int frame_index, uint64_t &value);
